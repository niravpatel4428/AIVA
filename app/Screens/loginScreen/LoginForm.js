        ...
        <form className="relative w-full">
          ...
          <div className="mb-4">
            ...
            onClick={togglePasswordVisibility}
                ...
                alt={showPassword ? "Hide password" : "Show password"} className="absolute right-4 top-[50%] translate-y-[-50%]" 
              />
              <input
          ...
          <div className="flex flex-row justify-between mb-6">
            ...
            <Link href="/" className="text-brightBlue text-sm font-MetRegular underline hover:text-brightBlue/80">Forgot Password</Link>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-[#707070] text-sm font-MetRegular">Dont have an account? <Link href="/" className="text-brightBlue hover:text-brightBlue/80 underline"> Sign up now</Link></p>
          </div>
        </form>
      </div>
    </>
