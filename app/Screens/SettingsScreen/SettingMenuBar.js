  ...
  return (
    <div className="w-full md:max-w-[217px] max-md:mb-4">
      <div className="flex max-sm:flex-col max-md:flex-row max-md:flex-wrap md:flex-col">
        <div
          className={`flex flex-row gap-2 items-center p-[16px_8px] rounded-[16px] sm:rounded-[16px_16px_0px_0px] md:rounded-[16px_0px_0px_16px] cursor-pointer ${
            activeSection == "edit-profile" ? "bg-white" : ""
          }`}
        ...
        >
          ...
          />
          <p
            className={`text-darkGray text-sm font-MetMedium hover:text-brightBlue ${
              activeSection === "edit-profile" ? "!text-brightBlue" : ""
            }`}
          >
            Edit Profile
          </p>
        ...
        <div
          className={`flex flex-row gap-2 items-center p-[16px_8px] rounded-[16px] sm:rounded-[16px_16px_0px_0px] md:rounded-[16px_0px_0px_16px] cursor-pointer ${
            activeSection == "notification-settings" ? "bg-white" : ""
          }`}
        ...
        >
          ...
          <p className="text-darkGray text-sm font-MetMedium hover:text-brightBlue">
            About
          </p>
        </div>
      </div>
